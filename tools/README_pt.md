...
<table>
  <tr>
    <td>
      <a href="javascript:void(0);" onclick="window.open('https://raw.githubusercontent.com/dissidentbr/divergent.manifest/main/img/brave_tor.mp4', 'popup', 'width=800,height=600'); return false;" target="_blank">
